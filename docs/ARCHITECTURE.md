...
| 6. Проводник и игроки в «Я» | Персонаж-стикер встречает и за 20 секунд показывает приложение; в «Я» — наши в лидерах, позже состав-стикербук, «Мой игрок», альбом сезона | ADR-010 | предложено, ждёт ответов владельца продукта |
