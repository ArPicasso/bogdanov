...
| 6. Проводник и игроки в «Я» | Персонаж-стикер встречает и за 20 секунд показывает приложение; в «Я» — наши в лидерах, позже состав-стикербук, «Мой игрок», альбом сезона | ADR-010 | принято; сделаны Кэп в онбординге, тур и «в лидерах» в «Я», ждут картинки поз. Остальное — после сайта РХЛ |
