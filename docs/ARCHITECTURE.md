...
| 6. Проводник и игроки в «Я» | Персонаж-стикер встречает и за 20 секунд показывает приложение; в «Я» — наши в лидерах, позже состав-стикербук, «Мой игрок», альбом сезона | ADR-010 | «в лидерах» в «Я» — сделано. Кэп и тур написаны, но на паузе (флаг `CAP_ON`): владелец продукта вернётся к идее. Остальное — после сайта РХЛ |
