...
| --- | --- | --- | --- |
| 1. Эмблемы всех клубов | Эмблемы 26 клубов вместо стикеров с аббревиатурой | — | 23 из 26. Добавлены «Ахмат-Гранит», «Динамо-Карелия», «Калужские Ракеты», «Ростов» (Википедия). Нет у «Витязь-Подольска», «Краснодара», «Красной машины Академии»: в открытом доступе их эмблем не нашлось — просить у пресс-служб или ждать `rhl.fhr.ru` |
| 2. История очных встреч | В карточке матча: победы, голы, пять последних игр, кто сильнее по истории | ADR-006 | в работе |
| 3. Составы на сезон | В «Я» под паспортом — состав любимой команды, лидеры, карточка игрока; составы соперников из карточки матча | ADR-007 | ждёт `rhl.fhr.ru`: на нём составы 2026/27 |
