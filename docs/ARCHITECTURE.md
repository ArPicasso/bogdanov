...
**25.09.2026, сервер и живой матч.** Лига разрешила опрашивать онлайн раз в 20–30 секунд во
время матчей — этап 4 («Живой матч») становится возможен без человека на арене. Для этого и для
постоянно работающего бота нужен сервер в России и домен: онлайн лиги закрыт для зарубежных
адресов, а у бота до сих пор нет постоянного хостинга. Фонбет предложил линию РХЛ — не берём.
Решение, порядок до 3 октября и вопросы к лиге — ADR-012, статус «предложено».
