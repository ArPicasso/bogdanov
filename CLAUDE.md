...
| `stickers/` | Стикеры бота 512×512 WEBP и их исходник `stickers.html` (ADR-005) |
| `tools/render_stickers.js` | Перерисовать `stickers/*.webp` (Playwright, запускается руками) |
